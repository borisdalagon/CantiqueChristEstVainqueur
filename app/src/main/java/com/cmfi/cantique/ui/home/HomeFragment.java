package com.cmfi.cantique.ui.home;
...
import com.cmfi.cantique.Adapter.AdapterListCantique;
...
public class HomeFragment extends Fragment {
    ...
    List<ListCantique>  listItems = new ArrayList<>();

    BaseListener listener;
    AdapterListCantique adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        listeDesCantique( root );

        return root;
    }


    public void listeDesCantique(View v) {
        ...
        addCantiqueToList( "1", "Grand Dieu, nous te bénissons",
        ...
        addCantiqueToList( "2", "Christ est Vainqueur,",
        ...
        addCantiqueToList( "6", "O Nom divin, nom rédempteur",
        ...
        addCantiqueToList( "9", "Esprit de Dieu, de vérité",
        ...
        addCantiqueToList( "11", "Jésus est le libérateur",
        ...
        addCantiqueToList( "26", "Venez au sauveur qui vous aime,",
        ...
        addCantiqueToList( "27", "Qui me relève dans mes chutes ?",
                ...
                "3. Sauvé, je ne me glorifie\n" +
                        ...
                        "Vers Jésus-Christ !", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "28", "Au pied de la croix sanglante",
                ...
                "Le parfait bonheur, (bis)\n" +
                        ...
                        "tes pieds, Seigneur !", "", "", "", "", "" );
        addCantiqueToList( "29", "MISÉRICORDE insondable !",
        ...
        addCantiqueToList( "30", "Tel que je suis, sans rien à moi,",
                ...
                "4. Tel que je suis, ton grand amour,\n" +
                        ...
                        "Agneau de Dieu, je viens ! Je viens !", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "31", "Jésus, par ton sang précieux,",
        ...
        addCantiqueToList( "32", "Ne crains rein, je t’aime !",
        ...
        addCantiqueToList( "33", "Oh ! C’est la croix notre chemin",
        ...
        addCantiqueToList( "34", "Entre tes mains j’abandonne",
                ...
                "4. Prends mon corps et prends mon âme\n" +
                 ...
                 "Oui, prends tout Seigneur ! (bis)\n" +
                         ...
                         "Règne sur mon cœur!", "", "" );
        addCantiqueToList( "35", "L’heure approche, la nuit vient",
                ...
                "Le repos (bis)\n" +
                        ...
                        "le servir.", "", "", "", "", "" );
        addCantiqueToList( "36", "Dis-moi quel est le but de ta vie ?",
        ...
        addCantiqueToList( "37", "Le monde m’a cloué sur cette croix infâme",
        ...
        addCantiqueToList( "38", "MERVEILLEUX amour, Mystérieux amour",
        ...
        addCantiqueToList( "39", "Toi égaré, connais-tu ton lendemain ?",
        ...
        addCantiqueToList( "40", "O ! DIEU merci, merci pour ton ESPRIT",
        ...
        addCantiqueToList( "41", "Toi qui dispose, de toutes choses,",
        ...
        addCantiqueToList( "42", "A JESUS je m’abandonne Ce qui me dit, je le crois,",
        ...
        addCantiqueToList( "43", "Qu’il fait bon à ton service, Jésus, mon sauveur !",
                ...
                "Prends, ô Jésus prends ma vie,\n" +
                        ...
                        "Du mal garde-moi !", "", "", "", "", "" );
        addCantiqueToList( "44", "JESUS dit: je suis le chemin, La vérité, la vie.",
        ...
        addCantiqueToList( "45", "Roc séculaire, frappé pour moi",
                ...
                "Roc séculaire, frappé pour moi\n" +
                        "Sur le calvaire, je viens à toi", "", "", "", "", "" );
        addCantiqueToList( "46", "Jésus est un trésor immense;",
                ...
                "3. Je sais que tu sera fidèle;\n" +
                        ...
                        "Dans ton amour.", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "47", "O ! Toi qui dit que Jésus-Christ n’est pas vivant",
        ...
        addCantiqueToList( "48", "J’ai soif de ta présence,",
                ...
                "Chaque jour, à chaque heure,\n" +
                        ...
                        "Auprès de moi.", "", "", "", "", "" );
        addCantiqueToList( "49", "C’est mon joyeux service",
        ...
        addCantiqueToList( "50", "Mon corps, mon cœur, mon âme ;",
        ...
        addCantiqueToList( "51", "Mon cœur joyeux, plein d’espérance,",
        ...
        addCantiqueToList( "52", "Toujours joyeux, telle est notre devise,",
                ...
                "2. Joyeux encore au fort de la bataille\n" +
                        ...
                        "Toujours joyeux, toujours joyeux !",
                "", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "53", "Où iras-tu quand Jésus reviendra,",
                ...
                "Où iras-tu quand Jésus reviendra,\n" +
                        ...
                        "Où iras-tu quand Jésus reviendra ?", "", "", "", "", "", "" );
        addCantiqueToList( "54", "Mon cœur voudrait t’aimer",
                ...
                "3. Mon cœur voudrais t’aimer\n" +
                        ...
                        "Je veux assez t’aimer\n" +
                        "Pour tout espérer.", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "55", "Mon Dieu, plus près de toi Plus près de toi !",
                ...
                "4. Mon Dieu plus près de toi !\n" +
                        ...
                        "Plus près de toi.", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "56", "Par la croix, oui ! J’entrerai au ciel",
        ...
        addCantiqueToList( "57", "JESUS est le Roc, le roc de mon salut.",
        ...
        addCantiqueToList( "58", "Le Seigneur Jésus il nous a aimé, il nous a choisis",
                ...
                "Le Seigneur Jésus,\n" +
                        ...
                        , "", "", "", "", "", "" );
        addCantiqueToList( "59", "Entends-tu l’appel du maitre ?",
        ...
        addCantiqueToList( "60", "Comme un fleuve immense est la paix de Dieu",
        ...
        addCantiqueToList( "61", "Si je suis dans l’obscurité",
        ...
        addCantiqueToList( "62", "Moment si doux de la prière où Dieu, m’élevant jusqu’à lui,",
        ...
        addCantiqueToList( "63", "Seigneur, Seigneur, Que ton Esprit descende sur nous,",
                "1.Seigneur, Seigneur,\n" +
                ...
                "3. Seigneur, Seigneur,\n" +
                        ...
                        "Que ton Onction descende sur nous;\n" +
                        "selon ta promesse.", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "64", "Oh ! Que ton joug est facile ! Oh ! Combien j’aime ta loi",
        ...
        addCantiqueToList( "65", "Toujours ta divine présence Jette un rayon sur mon chemin",
        ...
        addCantiqueToList( "66", "Je suis heureux je chante ! C’est pour toi !",
                ...
                "4. Que se dressent les montagnes\n" +
                        ...
                        "Alléluia !", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "67", "Me voici Seigneur Jésus Prends le trône de mon cœur,",
        ...
        addCantiqueToList( "68", "Il est le Dieu qui accomplit ses promesses ;",
        ...
        addCantiqueToList( "69", "J’ ai été crucifié avec Christ",
                "Gal 2:20\n" +
        ...
        addCantiqueToList( "70", "O vous qui n’avez pas la paix,",
                ...
                "3. Vous qui tremblez sous la terreur\n" +
                        ...
                        "Gloire, gloire à Jésus !", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "71", "Quel repos céleste Jésus, D’être à toi !",
                ...
                "Quel repos (ter)\n" +
                        "Quel céleste repos !", "", "", "", "", "" );
        addCantiqueToList( "72", "Proclamons de Dieu les bienfaits",
                ...
                "Nous avons un Dieu fidèle\n" +
                        ...
                        "Que son nom exalté !", "", "", "", "", "" );
        addCantiqueToList( "73", "Tout joyeux, bénissons le Seigneur !",
        ...
        addCantiqueToList( "74", "Ta main se déploya Pour leur donné un même cœur",
        ...
        addCantiqueToList( "75", "Oh ! Que ta main paternelle me bénisse à mon coucher !",
                ...
                "5. Seigneur, j’ai fait ma prière ;\n" +
                        ...
                        "(bis)", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "76", "Même si on m’accule,Même si je souffre,",
        ...
        addCantiqueToList( "77", "Semons dès l’aurore,",
        ...
        addCantiqueToList( "78", "Oui ! Mon cœur est plein d’espérance",
        ...
        addCantiqueToList( "79", "O Jésus dans la passion De ton amour pour moi",
                ...
                "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "80", "Veux-tu briser du péché le pouvoir ?",
        ...
        addCantiqueToList( "81", "Moi j’ai décidé de suivre Jésus",
                ...
                "Veux-tu décider de suivre Jésus (bis)\n" +
                        ...
                        "Oui très bientôt.", "", "", "" );
        addCantiqueToList( "82", "Travaillons et luttons, nous sommes au Seigneur.",
        ...
        addCantiqueToList( "83", "Je lève les yeux vers Toi Seigneur",
                ...
                "3. Je lève mes yeux vers toi Seigneur !\n" +
                        ...
                        "Et ma voix est l’écho de mon cœur\n" +
                        "Pour te dire mon amour.", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "84", "PSAUMES 138\n" +
        ...
        addCantiqueToList( "85", "Nous voici Seigneur Jésus !",
                ...
                "4. Nous voici Seigneur Jésus,\n" +
                        ...
                        "Daigne nous rendre vaillants\n" +
                        "Comme toi Seigneur.", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "86", "Quelle gloire \n" +
        ...
        addCantiqueToList( "87", "A de nouveaux combats, Jésus, tu nous appelles,",
        ...
        addCantiqueToList( "88", "Celui qui met en Jésus Une pleine confiance,",
        ...
        addCantiqueToList( "89", "Dieu a un plan pour ma vie J’irai partout dans le monde",
        ...
        addCantiqueToList( "90", "Nous n’avons pas , Ici bas de cité permanente",
        ...
        addCantiqueToList( "91", "Mon fils, mon cher enfant m’aimes-tu assez ?",
        ...
        addCantiqueToList( "92", "Nous ne travaillons pas pour manger",
                ...
                "Nous devons (bis)\n" +
                        ...
                        "Le Seigneur (bis)\n" +
                        "Ne nous l’a-t-il pas commandé ?", "", "", "", "", "" );
        addCantiqueToList( "93", "Fanez-vous voies terrestres",
                ...
                "4. Adieu mortalité ;\n" +
                        ...
                        "Jésus est mien", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "94", "Il pourvoira à nos besoins Selon ses richesses en Jésus",
        ...
        addCantiqueToList( "95", "Lève-toi, vaillante armée Pour les combats du Seigneur",
        ...
        addCantiqueToList( "96", "Lève-toi armée de gloire De ton Roi tiens le drapeau",
                ...
                "6. En avant toujours fidèles,\n" +
                        ...
                        "proclamé. (bis)", "", "", "", "", "", "", "" );
        addCantiqueToList( "97", "La moisson est grande mais il y a peu d’ouvriers",
                ...
                "La moisson est grande mais il\n" +
                        ...
                        "dans sa moisson. (bis)", "", "", "",
                "", "", "" );
        addCantiqueToList( "98", "Toi fils de l’homme je t’établis sentinelle",
        ...
        addCantiqueToList( "99", "L’Eglise est fondée, Sur Jésus son Seigneur",
        ...
        addCantiqueToList( "100", "Viendra-t-il ? Il viendra le réveil attendu",
        ...
        addCantiqueToList( "101", "Tout est à toi Seigneur Le don le plus grand",
        ...
        addCantiqueToList( "102", "Ici nous nous sommes",
                ...
                "Eh oui ! Pour vous,\n" +
                        ...
                        "Être des serviteurs.", "", "", "", "", "", "" );
        addCantiqueToList( "103", "Ecoute la voix qui crie à ton cœur",
                ...
                "C’est le Seigneur qui frappe à ta porte\n" +
                        ...
                        "Ouvre-moi, ouvre-moi.", "", "", "", "", "" );
        addCantiqueToList( "104", "Dans les cieux règne le Dieu vivant",
                ...
                "4. plions-nous sous son bras souverain\n" +
                        ...
                        "Louez-le, louez-le.", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "105", "Je ne vivrai pas comme une poule sur la terre",
                ...
                "Oui ma vie aura sur la terre\n" +
                        ...
                        "le Roi.", "" );
        addCantiqueToList( "106", "Le monde vit dans le péché",
        ...
        addCantiqueToList( "107", "Ta gloire est grande sur toute la terre",
        ...
        addCantiqueToList( "108", "Que cherches-tu ? Quand tu ne cesse de courir",
        ...
        addCantiqueToList( "109", "Combien de chemins as-tu parcouru",
                "1. Tu as besoin d’être aimé\n" +
                        "Tu as besoin d’être écouté\n" +
                        "Besoin d’un ami, besoin de paix\n" +
        ...
        addCantiqueToList( "110", "Si à lui tu t’es vraiment confié",
        ...
        addCantiqueToList( "111", "O tendre Père, donne-moi",
                ...
                "6. Je veux connaitre la haine\n" +
                        ...
                        "Donne-moi  (bis)\n" +
                        "Un cœur contrit et brisé.", "", "", "", "", "", "", "" );
        addCantiqueToList( "112", "Toi mon ami c’est pour toi que je chante",
                ...
                "Toi mon ami c’est pour toi que je chante\n" +
                        ...
                        "CHRIST à te donner.", "", "", "", "", "", "" );
        addCantiqueToList( "113", "A moi les cœurs braves ! A dit le Vainqueur",
        ...
        addCantiqueToList( "114", "Jésus-Christ est ma sagesse Il éclaire mon chemin",
                ...
                "4. Jésus en payant ma dette\n" +
                        ...
                        "pour l’éternité.", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "115", "Au combat de la vie Conscrits et vétérans,",
        ...
        addCantiqueToList( "116", "Jésus guérit, il pardonne, il délivre, il libère",
        ...
        addCantiqueToList( "117", "Viens avec tous tes fardeaux mon ami",
        ...
        addCantiqueToList( "118", "Un nom si doux réjouit mon cœur,",
        ...
        addCantiqueToList( "119", "Sur la place du village ils sont accourus,",
                ...
                "4. Et soudain la vie divine\n" +
                        ...
                        "guérit encore. Ch.", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "120", "Comme une terre altérée soupire après l’eau du ciel",
                ...
                "Fraîches rosées\n" +
                        ...
                        "O divine ondées,\n" +
                        "Venez arrosez-nous", "", "", "", "", "" );
        addCantiqueToList( "121", "Quand la trompette céleste Annoncera les temps nouveaux",
        ...
        addCantiqueToList( "122", "Divin Rocher, refuge sûre",
                ...
                "Jésus est un Roc dans un pays troublé\n" +
                        ...
                        "L’abri pour nous dans la tempête !", "", "", "", "", "" );
        addCantiqueToList( "123", "Roi de ma vie, reçois l’hommage,",
        ...
        addCantiqueToList( "124", "Quand la Bible ici bas ! Illumine nos pas,",
        ...
        addCantiqueToList( "125", "Debout, sainte cohorte",
                ...
                "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "126", "Frères , en avant Dans la sainte guerre !",
                "1.Frères , en avant\n" +
        ...
        addCantiqueToList( "127", "La lutte suprême\n" +
                ...
                "Du Christ, la bannière\n" +
                        ...
                        "Soldats en avant !", "", "", "", "", "" );
        addCantiqueToList( "128", "CHRIST est ressuscité\n" +
        ...
        addCantiqueToList( "129", "Chantons du Seigneur la bonté",
                ...
                "Toute ma vie je chanterai,\n" +
                        ...
                        "Toute ma vie je chanterai :\n" +
                        "Jésus fait bien tout ce qu’il fait.", "", "", "", "", "" );
        addCantiqueToList( "130", "Seigneur, attire mon cœur à toi,",
                "1. Seigneur, attire\n" +
                        "Mon cœur à toi,\n" +
                        "Je te désire\n" +
                        "Tout près de moi,\n" +
        ...
        addCantiqueToList( "131", "La voix du Seigneur m’appelle",
        ...
        addCantiqueToList( "132", "Quand le vol de la tempête",
        ...
        addCantiqueToList( "133", "Espere en DIEU quand la nuit sombre",
        ...
        addCantiqueToList( "134", "Qu’on batte des mains ! Que tous les humains,",
        ...
        addCantiqueToList( "135", "Près du trône de la grâce et de la Paix,",
                ...
                "Viens, oh ! Viens, Viens avec moi\n" +
                        ...
                        "Viens à la croix !", "", "", "", "", "" );
        addCantiqueToList( "136", "Seigneur, ta mort à Golgotha\n" +
        ...
        addCantiqueToList( "137", "Réveille-nous, Seigneur",
        ...
        addCantiqueToList( "138", "Seigneur, ce que mon cœur réclame",
                ...
                "3.Nous voulons porter\n" +
                        ...
                        "Par le feu (ter)", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "139", "JESUS m’a dit Mets ta main dans ma main et viens",
        ...
        addCantiqueToList( "140", "En CHRIST seul est mon espérance",
        ...
        addCantiqueToList( "141", "Viens mon âme te réclame,",
        ...
        addCantiqueToList( "142", "O SEIGNEUR tu es le Roi ! Tu règnes à toujours.",
                ...
                "3. O Jésus, tu es venu dans l’humanité\n" +
                        ...
                        "t’acclamer !", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "143", "Seigneur, tu donnes ta grâce",
                ...
                "5. Par ton amour, Ô bon Père,\n" +
                        ...
                        "Sauve-moi (bis)\n" +
                        "Dieu trois fois Saint sauve-moi !", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "144", "C’est toi Jésus, que recherche mon âme",
        ...
        addCantiqueToList( "145", "Il me conduit, douce pensée !",
        ...
        addCantiqueToList( "146", "J’entrerai dans ses parvis avec joie dans mon cœur,",
                ...
                "4. Je chanterai car il est Roi\n" +
                        "des rois.", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "147", "Que ferai-je pour toi Tu as tout fait pour moi",
                ...
                "Que ferai-je pour toi\n" +
                        ...
                        "Que ferai-je pour toi\n" +
                        "Tu as tout fait pour moi.", "", "", "", "", "", "" );
        addCantiqueToList( "148", "Je suis dans la joie Quand on me dis",
                ...
                "Je suis dans la joie\n" +
                        ...
                        "l’Eternel.", "", "", "", "", "", "" );
        addCantiqueToList( "149", "Quel sort merveilleux d’être sauvé",
                ...
                "Sauvé, Sauvé.\n" +
                        ...
                        "Sauvé, Sauvé.\n" +
                        "À jamais un enfant de Dieu.", "", "", "", "", "" );
        addCantiqueToList( "150", "Entends-tu le chant joyeux?",
                ...
                "4. jusqu’au confins des déserts\n" +
                        ...
                        "Jésus Sauve aujourd'hui !", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "151", "Il est vivant, il est vivant",
        ...
        addCantiqueToList( "152", "Source de grâce, source efficace,",
        ...
        addCantiqueToList( "153", "Dieu tu es bon, Dieu tu es doux,",
                "Dieu tu es bon,\n" +
                        "Dieu tu es doux, (bis)\n" +
                ...
                "2. Excellent est ton Nom,\n" +
                        ...
                        "Dieu tu es merveilleux,\n" +
                        "Mon Dieu tu es excellent.", "", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "154", "Je chanterais ton amour En union avec les anges",
        ...
        addCantiqueToList( "155", "Le zèle de ta maison",
        ...
        addCantiqueToList( "156", "Si seulement tu crois et je crois",
        ...
        addCantiqueToList( "157", "Oui j’ai vu ! Vu ! La victoire de Jésus.",
                ...
                "Oui j’ai vu ! Vu !\n" +
                        ...
                        "La défaite de satan\n" +
                        "Gloire soit à Dieu ! Amen.", "", "", "", "", "" );
        addCantiqueToList( "158", "J’aime le Seigneur",
                ...
                "4. Il m’a sauvé (ter)\n" +
                        "Du lac de feu.", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "159", "Bénis Dieu, Ô mon âme\n" +
        ...
        addCantiqueToList( "160", "Seigneur, tu es sûrement bon\n" +
        ...
        addCantiqueToList( "161", "Jéhovah jiré, l’Eternel pourvoit",
        ...
        addCantiqueToList( "162", "Qui est comme toi, Ô Seigneur",
                "Qui est comme toi,\n" +
                        "Ô Seigneur\n" +
        ...
        addCantiqueToList( "163", "Nul n’est saint comme l’Eternel,",
        ...
        addCantiqueToList( "164", "Viens, oui viens !\n" +
                ...
                "Viens, oui viens !\n" +
                        ...
                        "Viens, oui viens !", "", "", "", "", "", "" );
        addCantiqueToList( "165", "Il est Roi, il est Roi, Il est ressuscité, il est Roi",
                "Il est Roi, il est Roi,\n" +
                        "Il est ressuscité, il est Roi,\n" +
                        "Tout genou fléchira,\n" +
                        "Toute langue confessera\n" +
                        "Que Jésus-Christ est Roi.", "", "", "", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "166", "Il règne dans mon cœur,Il règne au Cameroun",
        ...
        addCantiqueToList( "167", "Criez sur les monts des oliviers ! Oliviers !",
        ...
        addCantiqueToList( "168", "Chantons, chantons sans cesse",
        ...
        addCantiqueToList( "169", "Par tous les saints glorifié,",
                ...
                "5. Pour nous il fut crucifié ;\n" +
                        ...
                        "Gloire à l’agneau (ter) sacrifié !", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "170", "Sans attendre, je veux tendre,",
                ...
                "4. Dieu de grâce, que ta face,\n" +
                        ...
                        "O mon Dieu mon Roi !", "", "", "", "", "", "", "", "", "" );
        addCantiqueToList( "171", "A Dieu soit la gloire ! Pour son grand amour",
        ...
        addCantiqueToList( "172", "Dis non aux tentations :\n" +
                "céder c’est pécher",
                ...
                "3. Tout vainqueur connaitra le\n " +
                        ...
                        "porter tout au long.", "", "", "", "",
                "", "", "", "", "", "" );
        addCantiqueToList( "173", "Dieu est très Saint ! Oui trois fois Saint.",
        ...
        addCantiqueToList( "174", "Garde –moi ô Seigneur, auprès de toi",
                ...
                "6. Garde - moi ô Seigneur,\n" +
                        ...
                        "Garde-moi ô Seigneur, auprès\n" +
                        "de Toi. (bis)\n", "", "", "", "", "", "", "" );
        addCantiqueToList( "175", "La puissance de dieu\n" +
                ...
                "La puissance de dieu\n" +
                        ...
                        "Eh ! Eh ! Gloire à Dieu !", "", "", "", "", "", "" );
        addCantiqueToList( "176", "Oui mon cœur chante pour Jéhovah Jiré",
                ...
                "Oui mon cœur chante\n" +
                        ...
                        "chante sa grâce\n" +
                        "Sa bonté, Son amour.", "", "", "", "", "", "" );
        addCantiqueToList( "177", "Dans la joie, dans l’amour, dans la foi",
        ...
        addCantiqueToList( "178", "Dieu tout–Puissant, quand mon cœur considère,",
                "Dieu tout–Puissant,\n" +
                ...
                "Alors mon cœur redit, la nuit, le jour\n" +
                        "Que tu es bon, O Dieu d’amour.", "", "" );
        addCantiqueToList( "179", "Avons-nous mérité Tant d’amour",
                "1. Avons-nous mérité\n" +
                        "Tant d’amour\n" +
                        "Avons-nous mérité\n" +
                ...
                "Sois loué (4 fois)\n" +
                        "Ô seigneur Jésus", "", "", "", "", "" );
        addCantiqueToList( "180", "As-tu faim, es-tu déprimé ?",
        ...
        addCantiqueToList( "181", "A celui qui nous aime Et qui nous a délivrés",
        ...
        addCantiqueToList( "182", "Crie pour le Seigneur : Oh ! Oh ! Oh !",
                ...
                "Crie pour le Seigneur : Oh ! Oh ! Oh !\n" +
                        ...
                        "Sont à toi Seigneur.\n" +
                        "Tu es notre amour !", "", "", "", "", "", "" );
        addCantiqueToList( "183", "Dire à tout le monde, Je voudrais le dire",
        ...
        addCantiqueToList( "184", "O jour heureux, jour de bonheur,",
                ...
                "Quel beau jour ! (bis)\n" +
                        ...
                        "Quel beau jour ! (bis)\n" +
                        "Où d’un sauveur, j’ai su l’amour !", "", "", "", "", "", "" );
        addCantiqueToList( "185", "L’amour de dieu de loin surpasse",
        ...
        addCantiqueToList( "186", "Jésus doux maitre, Règne sur moi,",
        ...
        addCantiqueToList( "187", "Un seul Roi règne sur la terre,",
        ...
        addCantiqueToList( "188", "Dans les profondeurs. Dans les lieux très hauts,",
        ...
        addCantiqueToList( "189", "Qu’il entende nos mains",
        ...
        addCantiqueToList( "190", "Dieu nous t’aimons Alléluia, Alléluia",
                ...
                "6. Dieu nous t’aimons, nous t’adorons\n" +
                        "Alléluia, Alléluia (bis).", "", "", "", "", "", "", "" );
        addCantiqueToList( "191", "Au pied de la sainte croix Jaillit la fontaine",
                ...
                "oh Sauveur !\n" +
                        ...
                        "Que je me confie.", "", "", "", "", "" );
        addCantiqueToList( "192", "Jésus te confie une œuvre d’amour,",
        ...
        addCantiqueToList( "193", "Je ne sais pas le jour où je verrai mon Roi,",
                ...
                "pour moi, pour moi s’ouvre le ciel (bis)\n" +
                        "Un regard de Jésus sera ma bienvenue,\n" +
                        "Pour moi, pour moi s’ouvre le ciel.", "", "", "" );
        addCantiqueToList( "194", "Prends ma vie, elle doit être A toi seul, Ô Divin maître !",
        ...
        addCantiqueToList( "195", "Quand je contemple cette croix",
        ...
        addCantiqueToList( "196", "De Bethlehem à la croix De la crèche à Golgotha",
        ...
        addCantiqueToList( "197", "Qui donc est dans cette table",
        ...
        addCantiqueToList( "198", "Pur et saint fils de Dieu Laissant la gloire de son royaume",
        ...
        addCantiqueToList( "199", "Sais-tu qu‟un jour tu seras",
        ...
        addCantiqueToList( "200", "Car Dieu a tant aimé le monde",
        ...
        addCantiqueToList( "201", "Où est ton trésor La sera ton cœur",
                "1. Où est ton trésor\n" +
                        "La sera ton cœur\n" +
                        "Tu peux te tromper\n" +
                        "De placement\n" +
        ...
        addCantiqueToList( "201", "Où est ton trésor",
                "1. Où est ton trésor\n" +
                        "La sera ton cœur\n" +
                        "Tu peux te tromper\n" +
                        "De placement\n" +
                        ...
                        "Prends donc le temps\n" +
                        "D‟y penser une heure.",
                "2. Le Christ est venu\n" +
                        "Pour tout pardonner\n" +
                        "L‟attrait de l‟argent\n" +
                        "Il peut l‟ôter\n" +
                        "Il faut savoir\n" +
                        "Que pour les hommes riches\n" +
                        "C‟est compliqué\n" +
                        "D‟être démuni.",
                "3. Amassez-vous\n" +
                        "Des trésors au ciel\n" +
                ...
                "L’argent ne suffit pas\n" +
                        ...
                        "Il faut d’autres trésors\n" +
                        "Pour combler nos vœux\n" +
                        "Si tu n’as soif que d’or\n" +
                        "Prépare tes yeux\n" +
                        "Tu apprendras un jour\n" +
                        "Qu’on n’achète pas Dieu.",
                "",
                "",
                "",
                "",
        ...
        addCantiqueToList( "202", "Pécheur, Je voudrais te guérir ;",
        ...
        addCantiqueToList( "203", "C‟est dans l‟Evangile qu‟on trouve",
        ...
        addCantiqueToList( "204", "Où cherchez-vous le bonheur",
        ...
        addCantiqueToList( "205", "Au loin sur la colline, se tient la",
        ...
        addCantiqueToList( "206", "Entends-tu Jésus t‟appelle,",
        ...
        addCantiqueToList( "207", "Sur le chemin, va sans peur,",
        ...
        addCantiqueToList( "208", "Ils ont mis le Maître sur la croix",
        ...
        addCantiqueToList( "209", "Il est Roi, Il est Roi",
        ...
        addCantiqueToList( "210", "Je suis fanatique de Jésus",
        ...
        addCantiqueToList( "211", "Jésus, nous Te louons",
        ...
        addCantiqueToList( "212", "Jésus quitta le trône de Son Père",
        ...
        addCantiqueToList( "213", "Au ciel est la maison du Père",
        ...
        addCantiqueToList( "214", "Ecoutez l‟appel du Berger !",
        ...
        addCantiqueToList( "215", "Quel autre au ciel ai-je que Toi ?",
        ...
        adapter = new AdapterListCantique( getContext(), listItems, listener );
    ...
    private void addCantiqueToList(String numero, String titre, String couplet1, String couplet2, String couplet3, String couplet4, String couplet5, String couplet6, String refrain, String refrain1, String refrain2, String refrain3, String refrain4, String refrain5, String refrain6) {

        listItems.add(new ListCantique(numero, titre, couplet1, couplet2, couplet3, couplet4, couplet5 , couplet6,refrain, refrain1,refrain2,refrain3,refrain4, refrain5, refrain6));

        Collections.sort( listItems, new Comparator<ListCantique>() {
            @Override
            public int compare(ListCantique o1, ListCantique o2) {
